...
public class Algorithms {
     ...
     */
    public native Track flattenStack(Stack inStack) throws Exception;
     ...
     * @return flattened track
     */
    public Track flattenStack(List<Track> tracks) throws Exception{
        Track[] trackArray = new Track[tracks.size()];
        trackArray = tracks.toArray(trackArray);
        return flattenStackNative(trackArray);
    }

    private native Track flattenStackNative(Track[] tracks) throws Exception;
     ...
     */
    public native Track trackTrimmedToRange(Track inTrack, TimeRange trimRange) throws Exception;
     ...
     */
    public Timeline timelineTrimmedToRange(Timeline inTimeline, TimeRange trimRange) throws Exception {
